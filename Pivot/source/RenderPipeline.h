...
#include "shaders/behind.frag"
		;
	const std::string emissionVert =
#include "shaders/emission.vert"
	;
	const std::string emissionFrag =
#include "shaders/emission.frag"
	;
...
#include "shaders/screen.frag"
	...
	std::shared_ptr<cugl::Shader> _shaderEmission;
	...
	std::shared_ptr<cugl::VertexBuffer> _vertbuffEmission;
