...
/**
 * Returns the number of bytes needed to convert a UNICODE string to UTF-8 
 *
 * @author Walker White
 */
...
static void UTF32_to_UTF8(const Uint32 *src, Uint8 *dst)
{
    ...
    while (*src) {
        Uint32 ch = *src++;
        if (ch == UTF32_BOM_NATIVE) {
            swapped = 0;
            continue;
        }
        if (ch == UTF32_BOM_SWAPPED) {
            swapped = 1;
            continue;
        }
        if (swapped) {
        ...
        if (ch <= 0x7F) {
            ...
            *dst++ = 0xE0 | (ch >> 12);                 /* 1110xxxx */
            *dst++ = 0x80 | ((ch >> 6) & 0x3F);         /* 10xxxxxx */
            *dst++ = 0x80 | (ch & 0x3F);                /* 10xxxxxx */
        } else if (ch <= 0x10FFFF) {
            *dst++ = 0xF0 | (ch >> 18);                 /* 11110xxx */
               *dst++ = 0x80 | ((ch >> 12) & 0x3F);     /* 10xxxxxx */
            *dst++ = 0x80 | ((ch >> 6) & 0x3F);         /* 10xxxxxx */
               *dst++ = 0x80 | (ch & 0x3F);             /* 10xxxxxx */
        }
    }
        ...
        int measure_width, int *extent, int *count)
{
    ...
    if (str_type == STR_TEXT) {
        ...
        text = (const char *)utf8_alloc;
    } else if (str_type == STR_UTF32) {
        // @author Walker White
        const Uint32 *text32 = (const Uint32 *) text;
        utf8_alloc = SDL_stack_alloc(Uint8, UTF32_to_UTF8_len(text32));
        if (utf8_alloc == NULL) {
            SDL_OutOfMemory();
            goto failure;
        }
        UTF32_to_UTF8(text32, utf8_alloc);
        text = (const char *)utf8_alloc;
    }
...
{
    return TTF_Size_Internal(font, (const char *)text, STR_UTF32, w, h, NULL, NULL, NO_MEASUREMENT);
}
...
/** @author Walker White */
int TTF_MeasureUTF32(TTF_Font *font, const Uint32 *text, int width, int *extent, int *count)
{
    return TTF_Size_Internal(font, (const char *)text, STR_UTF32, NULL, NULL, NULL, NULL, width, extent, count);
}
...
/** @author Walker White */
SDL_Surface* TTF_RenderUTF32_Solid(TTF_Font *font, const Uint32 *text, SDL_Color fg)
{
    return TTF_Render_Internal(font, (const char *)text, STR_UTF32, fg, fg /* unused */, RENDER_SOLID);
}
...
/** @author Walker White */
SDL_Surface* TTF_RenderUTF32_Shaded(TTF_Font *font, const Uint32 *text, SDL_Color fg, SDL_Color bg)
{
    return TTF_Render_Internal(font, (const char *)text, STR_UTF32, fg, bg, RENDER_SHADED);
}
...
/** @author Walker White */
SDL_Surface* TTF_RenderUTF32_Blended(TTF_Font *font, const Uint32 *text, SDL_Color fg)
{
    return TTF_Render_Internal(font, (const char *)text, STR_UTF32, fg, fg /* unused */, RENDER_BLENDED);
}
...
/** @author Walker White */
SDL_Surface* TTF_RenderUTF32_LCD(TTF_Font *font, const Uint32 *text, SDL_Color fg, SDL_Color bg)
{
    return TTF_Render_Internal(font, (const char *)text, STR_UTF32, fg, bg, RENDER_LCD);
}
...
/** @author Walker White */
SDL_Surface* TTF_RenderUTF32_Solid_Wrapped(TTF_Font *font, const Uint32 *text, SDL_Color fg, Uint32 wrapLength)
{
    return TTF_Render_Wrapped_Internal(font, (const char *)text, STR_UTF32, fg, fg /* unused */, wrapLength, RENDER_SOLID);
}
...
/** @author Walker White */
SDL_Surface* TTF_RenderUTF32_Shaded_Wrapped(TTF_Font *font, const Uint32 *text, SDL_Color fg, SDL_Color bg, Uint32 wrapLength)
{
    return TTF_Render_Wrapped_Internal(font, (const char *)text, STR_UTF32, fg, bg, wrapLength, RENDER_SHADED);
}
...
/** @author Walker White */
SDL_Surface* TTF_RenderUTF32_Blended_Wrapped(TTF_Font *font, const Uint32 *text, SDL_Color fg, Uint32 wrapLength)
{
    return TTF_Render_Wrapped_Internal(font, (const char *)text, STR_UTF32, fg, fg /* unused */, wrapLength, RENDER_BLENDED);
}
...
/** @author Walker White */
SDL_Surface* TTF_RenderUTF32_LCD_Wrapped(TTF_Font *font, const Uint32 *text, SDL_Color fg, SDL_Color bg, Uint32 wrapLength)
{
    return TTF_Render_Wrapped_Internal(font, (const char *)text, STR_UTF32, fg, bg, wrapLength, RENDER_LCD);
}
