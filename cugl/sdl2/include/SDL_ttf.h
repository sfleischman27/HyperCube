...
#define UTF32_BOM_NATIVE  0x0000FEFF
#define UTF32_BOM_SWAPPED 0xFFFE0000
...
/**
 * Calculate the dimensions of a rendered string of UTF32 text.
 *
 * This will report the width and height, in pixels, of the space that the
 * specified string will take to fully render.
 *
 * This does not need to render the string to do this calculation.
 *
 * This is an alternative to the UTF-8 version that allows us to manipulate text
 * directly at the code point level
 *
 * \param font the font to query.
 * \param text text to calculate, in UTF32 encoding.
 * \param w will be filled with width, in pixels, on return.
 * \param h will be filled with height, in pixels, on return.
 * \returns 0 if successful, -1 on error.
 *
 * \since This is a CUGL extension to SDL_ttf
 *
 * \author Walker White
 */
...
/**
 * Calculate how much of a UTF32 string will fit in a given width.
 *
 * This reports the number of characters that can be rendered before reaching
 * `measure_width`.
 *
 ...
 * \author Walker White
 */
extern DECLSPEC int SDLCALL TTF_MeasureUTF32(TTF_Font *font, const Uint32 *text, int measure_width, int *extent, int *count);
...
/**
 * Render UTF32 text at fast quality to a new 8-bit surface.
 *
 * This function will allocate a new 8-bit, palettized surface. The surface's
 * 0 pixel will be the colorkey, giving a transparent background. The 1 pixel
 * will be set to the text color.
 ...
 *
 * \param font the font to render with.
 * \param text text to render, in UTF32 encoding.
 * \param fg the foreground color for the text.
 * \returns a new 8-bit, palettized surface, or NULL if there was an error.
 *
 * \since This is a CUGL extension to SDL_ttf
...
/**
 * Render word-wrapped UTF32 text at fast quality to a new 8-bit surface.
 *
 * This function will allocate a new 8-bit, palettized surface. The surface's
 * 0 pixel will be the colorkey, giving a transparent background. The 1 pixel
 * will be set to the text color.
 ...
 * \author Walker White
 */
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF32_Solid_Wrapped(TTF_Font *font,
                const Uint32 *text, SDL_Color fg, Uint32 wrapLength);
...
/**
 * Render UTF32 text at high quality to a new 8-bit surface.
 *
 * This function will allocate a new 8-bit, palettized surface. The surface's
 * 0 pixel will be the specified background color, while other pixels have
 * varying degrees of the foreground color. This function returns the new
...
/**
 * Render word-wrapped UTF32 text at high quality to a new 8-bit surface.
 *
 * This function will allocate a new 8-bit, palettized surface. The surface's
 * 0 pixel will be the specified background color, while other pixels have
 * varying degrees of the foreground color. This function returns the new
 ...
 * \author Walker White
 */
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF32_Shaded_Wrapped(TTF_Font *font,
                const Uint32 *text, SDL_Color fg, SDL_Color bg, Uint32 wrapLength);
...
/**
 * Render UTF32 text at high quality to a new ARGB surface.
 *
 * This function will allocate a new 32-bit, ARGB surface, using alpha
 * blending to dither the font with the given color. This function returns the
 * new surface, or NULL if there was an error.
...
/**
 * Render word-wrapped UTF32 text at high quality to a new ARGB surface.
 *
 * This function will allocate a new 32-bit, ARGB surface, using alpha
 * blending to dither the font with the given color. This function returns the
 * new surface, or NULL if there was an error.
 ...
 * \author Walker White
 */
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF32_Blended_Wrapped(TTF_Font *font,
                const Uint32 *text, SDL_Color fg, Uint32 wrapLength);
...
/**
 * Render UTF32 text at LCD subpixel quality to a new ARGB surface.
 *
 * This function will allocate a new 32-bit, ARGB surface, and render
 * alpha-blended text using FreeType's LCD subpixel rendering. This function
 * returns the new surface, or NULL if there was an error.
 ...
 * \author Walker White
 */
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF32_LCD(TTF_Font *font,
                const Uint32 *text, SDL_Color fg, SDL_Color bg);   
...
/**
 * Render word-wrapped UTF32 text at LCD subpixel quality to a new ARGB
 * surface.
 *
 * This function will allocate a new 32-bit, ARGB surface, and render
 * alpha-blended text using FreeType's LCD subpixel rendering. This function
 ...
 * \author Walker White
 */
extern DECLSPEC SDL_Surface * SDLCALL TTF_RenderUTF32_LCD_Wrapped(TTF_Font *font,
                const Uint32 *text, SDL_Color fg, SDL_Color bg, Uint32 wrapLength);
...
#define TTF_RenderUTF32(font, text, fg, bg)   \
    TTF_RenderUTF32_Shaded(font, text, fg, bg)
