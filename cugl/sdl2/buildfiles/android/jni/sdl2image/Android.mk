...
#
###########################
SDL2_IMAGE_PATH := $(SDL2_PATH)/extensions/image
...
ifeq ($(SUPPORT_AVIF),true)
    include $(SDL2_IMAGE_PATH)/$(AVIF_LIBRARY_PATH)/Android.mk
    include $(SDL2_IMAGE_PATH)/$(DAV1D_LIBRARY_PATH)/Android.mk
endif

# Build the library
ifeq ($(SUPPORT_JPG),true)
    include $(SDL2_IMAGE_PATH)/$(JPG_LIBRARY_PATH)/Android.mk
endif

# Build the library
ifeq ($(SUPPORT_JXL),true)
    include $(SDL2_IMAGE_PATH)/$(JXL_LIBRARY_PATH)/Android.mk
endif

# Build the library
ifeq ($(SUPPORT_PNG),true)
    include $(SDL2_IMAGE_PATH)/$(PNG_LIBRARY_PATH)/Android.mk
endif

# Build the library
ifeq ($(SUPPORT_WEBP),true)
    include $(SDL2_IMAGE_PATH)/$(WEBP_LIBRARY_PATH)/Android.mk
endif

# Restore local path
LOCAL_PATH := $(SDL2_IMAGE_PATH)
