...
protected:
    ...
    /** The default read size of this node (in frames) */
    Uint32 _readsize;
...
#pragma mark Node Attributes
    ...
    /**
     * Returns the typical read size of this node.
     *
     ...
     *
     * @return the typical read size of this node.
     */
    Uint32 getReadSize() const { return _readsize; }
