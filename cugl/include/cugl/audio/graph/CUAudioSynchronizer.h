 ...
 * resolve this issue.
 *
 * To use this class, attach a node with three channels.  The first two channels
 * are stereo sound while the third channel represents the "beat".  Any non-zero
 * signal in this channel represents a beat window.
 *
...
private:
    ...
    /** The intermediate read buffer. Size is set by _readsize. */
    float* _buffer;
