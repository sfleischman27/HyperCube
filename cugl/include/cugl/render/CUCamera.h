 ...
 * with the mouse.
 *
 * The design of this class ensures that the direction vector and the up
 * vector of the camera are orthonormal at all times.
 */
class Camera {
#pragma mark Values
protected:
...
#pragma mark Updates
     ...
     */
    void normalizeUp() {
        Vec3 right = _direction;
        right.cross(_upwards).normalize();
        _upwards = right;
